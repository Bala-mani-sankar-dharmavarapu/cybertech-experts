...
interface CareerExpertDialogProps {
  phoneNumber?: string;
  message?: string;
}

const CareerExpertDialog: React.FC<CareerExpertDialogProps> = ({
  phoneNumber = watsappNumber, // Use centralized WhatsApp number
  message = "Hello! I'd like to talk to a career expert about your services.",
}) => {
  ...
  const handleWhatsAppClick = () => {
    ...
    setIsOpen(false); // Close dialog after opening WhatsApp
  };
...
export default CareerExpertDialog;
